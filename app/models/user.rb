...
class User < ApplicationRecord
  ...
  has_many :follower, class_name: 'Follow', foreign_key: 'follower_id', dependent: :destroy # フォローしている
  has_many :followed, class_name: 'Follow', foreign_key: 'followed_id', dependent: :destroy # フォローされている
